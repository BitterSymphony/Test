...
/**
 Base class for all ziweiyang views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ziweiyang view hierarchy (such as wrapped iOS UIViews) was touched.
