...
// in simulator we redefine to format for ziweiyang Developer console
...
{\
	NSString * exceptionName = [@"org.ziweiyang." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ziweiyang";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIziweiyangNativeItemNone = -1, 
	UIziweiyangNativeItemSpinner = -2,
	UIziweiyangNativeItemProgressBar = -3,
	
	UIziweiyangNativeItemSlider = -4,
	UIziweiyangNativeItemSwitch = -5,
	UIziweiyangNativeItemMultiButton = -6,
	UIziweiyangNativeItemSegmented = -7,
	
	UIziweiyangNativeItemTextView = -8,
	UIziweiyangNativeItemTextField = -9,
	UIziweiyangNativeItemSearchBar = -10,
	
	UIziweiyangNativeItemPicker = -11,
	UIziweiyangNativeItemDatePicker = -12,
	
	UIziweiyangNativeItemInfoLight = -13,
	UIziweiyangNativeItemInfoDark = -14,
	
	UIziweiyangNativeItemDisclosure = -15,
	
	UIziweiyangNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ziweiyang instances of
