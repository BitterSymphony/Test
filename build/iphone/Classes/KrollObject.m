...
//@interface ziweiyangObject : NSObject
//@end

@interface ziweiyangObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ziweiyangObject class]])
		{
			for (NSString *key in [[(ziweiyangObject*)o modules] allKeys])
			{
