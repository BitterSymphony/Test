...
@interface ziweiyangObject : KrollCoverageObject {
#else
@interface ziweiyangObject : KrollObject {
#endif
@private
...
extern NSString * ziweiyang$ModuleRequireFormat;
