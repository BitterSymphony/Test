...
function Controller() {
    ...
    function loadEvents() {
        var newsList = Alloy.Globals.newsDetail;
        for (var i = 0; i < newsList.length; i++) {
            var newsImgView = UI.createView({
                width: Ti.UI.FILL,
                height: 220,
                backgroundImage: apiHost + newsList[i].nPhoto[0]
            });
            $.nImg.add(newsImgView);
            $.nTitle.text = newsList[i].nTitle;
            $.nDate.text = newsList[i].nDate;
            $.nDetail.html = Encoder.htmlDecode(newsList[i].nDetail);
        }
    }
    function init() {}
    function cleanUp() {}
    require("alloy/controllers/BaseController").apply(this, Array.prototype.slice.call(arguments));
    this.__controllerPath = "screen/newsDetail";
    if (arguments[0]) {
        {
    ...
    $.__views.nTitle = Ti.UI.createLabel({
        widht: Ti.UI.SIZE,
        height: Ti.UI.SIZE,
        left: 10,
        top: 10,
    ...
    $.__views.__alloyId194.add($.__views.nTitle);
    $.__views.nDate = Ti.UI.createLabel({
        widht: Ti.UI.SIZE,
        height: Ti.UI.SIZE,
        left: 10,
        top: 10,
    ...
    $.__views.__alloyId194.add($.__views.nDate);
    $.__views.nImg = Ti.UI.createView({
        widht: Ti.UI.FILL,
        height: 220,
        top: 10,
        id: "nImg"
    });
    $.__views.__alloyId193.add($.__views.nImg);
    $.__views.nDetail = Ti.UI.createLabel({
        top: 10,
        left: 10,
        right: 10,
        height: Ti.UI.SIZE,
    ...
    $.__views.__alloyId193.add($.__views.nDetail);
    exports.destroy = function() {};
    _.extend($, $.__views);
    var args = arguments[0] || {};
    var news_api = require("newsDetail_api");
    ...
    Ti.App.addEventListener("newsDetailLoadCompleted", loadEvents);
    news_api.refresh(newsId);
    exports.init = init;
