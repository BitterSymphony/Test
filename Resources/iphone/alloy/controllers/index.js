...
function Controller() {
    ...
    function lockDrawer(e) {
        ...
        $.drawer.setOpenDrawerGestureMode(e.lock ? NappDrawerModule.OPEN_MODE_NONE : NappDrawerModule.OPEN_MODE_PANNING_NAVBAR);
    }
    ...
    $.__views.__alloyId11.leftNavButton = $.__views.__alloyId13;
    ...
    $.__views.__alloyId11.rightNavButton = $.__views.__alloyId16;
    $.__views.centerWindow = Ti.UI.iOS.createNavigationWindow({
    ...
    $.__views.drawer = Alloy.createWidget("nl.fokkezb.drawer", "widget", {
        ...
        closeDrawerGestureMode: "CLOSE_MODE_PANNING_CENTERWINDOW",
        leftDrawerWidth: 270,
        shadowWidth: "40dp",
        fading: .3,
        orientationModes: [ Ti.UI.PORTRAIT ],
        id: "drawer",
        children: [ $.__views.leftWindow, $.__views.centerWindow ]
    });
